...
sga_trinity:
	...
	Trinity --seqType fq --max_memory 50G --output ${SAMP}M.trinity_sga55 --trimmomatic --left sga.55.fq.1 --right sga.55.fq.2 --CPU $(CPU) --inchworm_cpu 10 --full_cleanup --quality_trimming_params "ILLUMINACLIP:${DIR}/scripts/barcod
es.fa:2:40:15 LEADING:2 TRAILING:2 MINLEN:25" && \
	Trinity --seqType fq --max_memory 50G --output ${SAMP}M.trinity_sga31 --trimmomatic --left sga.31.fq.1 --right sga.31.fq.2 --CPU $(CPU) --inchworm_cpu 10 --full_cleanup --quality_trimming_params "ILLUMINACLIP:${DIR}/scripts/barcod
es.fa:2:40:15 LEADING:2 TRAILING:2 MINLEN:25" && \
	python3 ~/BUSCO_v1.1b1/BUSCO_v1.1b1.py -g ${SAMP}M.trinity_sga55.Trinity.fasta -m Trans --cpu $(CPU) -l ~/BUSCO_v1.1b1/vertebrata && \
	python3 ~/BUSCO_v1.1b1/BUSCO_v1.1b1.py -g ${SAMP}M.trinity_sga31.Trinity.fasta -m Trans --cpu $(CPU) -l ~/BUSCO_v1.1b1/vertebrata && \
	mv *fasta ${DIR}/assemblies/
